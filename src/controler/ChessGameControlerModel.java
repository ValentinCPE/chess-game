...
public interface ChessGameControlerModel {
	 ...
	 * 
	 * Cette méthode est appelé par la méthode mousePressed de l'écouteur
	 * d'évènements souris.
	 * 
	 ...
	 * ou les méthodes de la vue (par exemple, fixer la pièce qui doit être déplacée,
	 ...
	 * @param targetCoord
	 * 
	 * Cette méthode est appelé par la méthode mouseReleased de l'écouteur
	 * d'évènements souris.
	 * 
	 * Elle permet d'invoquer des méthodes du model (par exemple move() ou pawnPromotion())
	 * ou les méthodes de la vue (par exemple, déplacer effectivement la pièce 
