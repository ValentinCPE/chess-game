 ...
 * 
 * Chaque fois qu'une action est effectuée sur le modèle, 
 * un message est envoyé à la vue
 * qui le récupère dans sa méthode update()
 *
 */
public class MessageModelToGUI implements Serializable {
	 ...
	 * @param actionType
	 */
	public MessageModelToGUI(Couleur couleur, int xInit, int yInit, int xFinal, int yFinal, ActionType actionType) {
