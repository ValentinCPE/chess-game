...
public class BoardGameConfig {
	...
	public static BoardGameConfig newInstance(int nbLigne, int nbColonne, String factoryName,
	...
	public static boolean coordonnees_valides(int x, int y){
		return ( (x<= BoardGameConfig.nbColonne-1) && (x>=0) && (y<=BoardGameConfig.nbLigne) && (y>=0) );
	}
