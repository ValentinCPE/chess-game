...
public class ChessGUI extends JFrame implements Observer {
	...
	private ChessTextGUI execTrace;		// affichage de la trace d'exécution dans un JPanel
	 ...
	 * 
	 * à chaque action dans le model,
	 * la vue récupère le message envoyé, 
	 * le décode (version minimaliste implémentée ...) et
	 * l'affiche
	 */
	@Override
